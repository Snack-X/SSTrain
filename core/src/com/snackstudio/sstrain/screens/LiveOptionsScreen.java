...
public class LiveOptionsScreen extends ChangeListener implements Screen, InputProcessor {
    ...
    public void show() {
        ...
        newBPosition = GlobalConfiguration.bTime == null || GlobalConfiguration.bTime > Assets.selectedBeatmap.metadata.duration.floatValue() ? Assets.selectedBeatmap.metadata.duration.floatValue() : GlobalConfiguration.bTime;
        ...
        aSlider = new Slider(0f, Assets.selectedBeatmap.metadata.duration.floatValue() - 6f, 1f, false, Assets.menuSkin);
        ...
        bSlider = new Slider(6f, Assets.selectedBeatmap.metadata.duration.floatValue(), 1f, false, Assets.menuSkin);
